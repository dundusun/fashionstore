...
function Register() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Inter', sans-serif" }}>
      {/* LEFT HALF - IMAGE */}
      <div style={{ flex: 1, background: 'url(https://images.unsplash.com/photo-1445205170230-053b83016050?w=1000&q=80) center/cover no-repeat', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 80px', background: '#fff' }}>
        <div style={{ maxWidth: '400px', width: '100%', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '10px' }}>Join the Club</h2>
          <p style={{ color: '#666', marginBottom: '40px' }}>Create an account for exclusive drops and VIP access.</p>
